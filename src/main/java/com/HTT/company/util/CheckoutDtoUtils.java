...
//		private Double total;
		...
		for (String keyValue : checkOutMap.get("mapProduct").split(" *}, *")) {
			...
			System.out.print("number " + keyValue.substring(keyValue.indexOf(")=") + 2, keyValue.length()-1));
			Integer number = Integer.parseInt(keyValue.substring(keyValue.indexOf(")=") + 2, keyValue.length()-1));
			try {
